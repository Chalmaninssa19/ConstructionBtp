                    ...
                    <div class="row flex-grow">
                        <div class="col-lg-4 mx-auto">
                            <div class="auth-form-light text-left p-5">
                                ...
                                <h6 class="font-weight-light">S'authentifier en tant que BTP pour continuer</h6>
                                <form class="pt-3" action="loginAdmin" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Username" name="username" value="Inssa">
                                    </div>
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Password" name="mdp" value="inssa">
                                    </div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <a href="/">
                                            <p class="text-small">Se connecter en tant que client</p>
                                        </a>
                                    </div>
                                </form>
                            </div>
